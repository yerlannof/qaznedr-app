        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex justify-between items-start">
            ...
            <Link
              ...
              className="bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 hover:shadow-md transition-all dark:bg-blue-600 dark:hover:bg-blue-700"
            >
          ...
          <div className="lg:col-span-3">
            ...
            {!loading && !error && (
              <div className="flex justify-between items-center mb-6">
                ...
                {/* View Toggle */}
                <div className="relative flex items-center gap-2 bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
                  <motion.button
                  ...
                  <motion.div
                    className="absolute top-1 h-8 bg-white dark:bg-gray-700 shadow-sm rounded-md"
                    animate={{
            ...
            {error && (
              <div className="text-center py-12">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors dark:bg-blue-600 dark:hover:bg-blue-700"
                >
                  Попробовать снова
                </button>
              </div>
