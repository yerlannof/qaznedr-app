...
import { ViewingNowIndicator, TrustBadge } from '@/components/features/SocialProof';
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between text-xs text-gray-500 pb-3 border-b border-gray-100">
          ...
          <div className="flex items-center space-x-2">
            <TrustBadge type="listing" verified={deposit.verified} className="text-xs px-2 py-1" />
          </div>
        </div>
