...
export const copilotTools = [
    ...
    },
    {
        ...
        description: "Get Copilot suggestions for code (simulated - actual suggestions require VS Code UI)",
        inputSchema: {
            type: "object",
            properties: {
                context: {
        ...
        handler: async (args) => {
            ...
            if (args.context.toLowerCase().includes("api") || args.context.toLowerCase().includes("fetch")) {
                suggestions.push({
                    type: "api_call",
    ...
    },
    {
        ...
        handler: async (args) => {
            ...
            return args.topic ? guides[args.topic] : guides;
        },
    },
];
